...
exports.deleteAccount = exports.deleteAllMessages = exports.panicDelete = void 0;
/**
...
exports.panicDelete = (0, https_1.onCall)({ region: 'asia-northeast1' }, async (request) => {
    // 認証チェック
    ...
    if (request.data.confirmationCode !== CONFIRMATION_CODE) {
        throw new https_1.HttpsError('invalid-argument', lang === 'en'
            ? 'Invalid confirmation code'
            : '確認コードが正しくありません');
    }
    // プレミアムユーザーチェック
    const isPremium = await (0, subscription_1.isPremiumUser)(userId);
    if (!isPremium) {
        return {
            success: false,
            error: lang === 'en'
    ...
    try {
        ...
        throw new https_1.HttpsError('internal', lang === 'en'
 ...
 */
exports.deleteAllMessages = (0, https_1.onCall)({ region: 'asia-northeast1' }, async (request) => {
    // 認証チェック
    const userId = (0, validators_1.requireAuth)(request.auth);
    const lang = request.data.lang;
    // プレミアムユーザーチェック
...
exports.deleteAccount = (0, https_1.onCall)({ region: 'asia-northeast1' }, async (request) => {
    // 認証チェック
    const userId = (0, validators_1.requireAuth)(request.auth);
    const lang = request.data.lang;
    try {
        ...
        for (const conversationDoc of conversationsSnapshot.docs) {
            ...
            const newParticipants = conversationData.participantIds.filter((id) => id !== userId);
...
//# sourceMappingURL=panicDelete.js.map