...
exports.verifyAppleReceipt = void 0;
/**
 ...
 */
async function verifyWithApple(receiptData, useSandbox) {
 ...
 * 最新のサブスクリプション情報を取得
 */
function getLatestSubscription(receipts) {
...
exports.verifyAppleReceipt = (0, https_1.onCall)({
    ...
    // 入力検証
    (0, validators_1.requireString)(request.data.receiptData, 'receiptData');
    ...
    try {
        ...
        if (appleResponse.status !== 0) {
            ...
            return {
                success: false,
                error: (0, messages_1.getMessage)(lang, 'subscription', 'receiptVerificationFailed'),
            };
        }
        // 最新のサブスクリプション情報を取得
        const latestReceipts = appleResponse.latest_receipt_info ||
            ((_a = appleResponse.receipt) === null || _a === void 0 ? void 0 : _a.in_app) || [];
        ...
        throw new https_1.HttpsError('internal', (0, messages_1.getMessage)(lang, 'subscription', 'verificationError'));
    }
});
//# sourceMappingURL=verifyAppleReceipt.js.map